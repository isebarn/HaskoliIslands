...
//    gl.enable(gl.CULL_FACE);
    ...
    gl.uniform1f( gl.getUniformLocation(program, "phong"), blinn );
    ...
    // Event listener for mousewheel
     ...
     window.addEventListener("keydown", function(e){
        switch(e.keyCode){
            case 38:
                materialShininess -= 1
                document.getElementById("Viewpoint").innerHTML = "Glans er : " + materialShininess;
                gl.uniform1f( gl.getUniformLocation(program, "shininess"), materialShininess );
                break;
            case 40:
                materialShininess += 1
...
function render() {
    ...
    gl.uniform1f( gl.getUniformLocation(program, "phong"), 1.0 );
    ...
    //HALF
    gl.uniform1f( gl.getUniformLocation(program, "phong"), 0.0 );
